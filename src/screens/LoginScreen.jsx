import { View, Text, ImageBackground, SafeAreaView, TouchableOpacity, Image, StyleSheet, TextInput, Switch } from 'react-native'
...
export default function Login({navigation}) {
  ...
  return (
    <SafeAreaView style={styles.LoginPage}>
      <>
        <ImageBackground source={require('../assets/loginbg.png')} resizeMode='cover' style={styles.BackgroundImage}>
      ...
      <View style={styles.Section}>
        ...
        <View style={styles.PasswordOptions}>
          <View style={styles.RememberMe}>
            ...
            />
            <Text style={{fontSize: 15, fontWeight: 500, color: '#868889'}}>Remember me</Text>
          </View>
          <TouchableOpacity onPress={() => navigation.navigate('Recovery screen')}>
            <Text style={{fontSize: 15, fontWeight: 500, color: '#407EC7'}}>Forgot password ?</Text>
          </TouchableOpacity>
        </View>
