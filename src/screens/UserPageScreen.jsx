...
export default function UserPage({navigation}) {
  return (
    <SafeAreaView style={styles.UserPage}>
      <View style={{height: 145, width: '100%', backgroundColor: '#FFF', position: 'absolute'}}></View>
      <View style={styles.ProfileSection}>
        <View>
          <Image style={{borderRadius: 100, position: 'relative', left: 15}} source={require('../assets/profilePhoto.png')}/>
        </View>
      ...
      <View style={styles.SettingsSection}>
        ...
        <TouchableOpacity style={styles.UserSetting} onPress={() => navigation.navigate('About me screen')}>
        ...
        <TouchableOpacity style={styles.UserSignOut} onPress={() => FIREBASE_AUTH.signOut()}>
