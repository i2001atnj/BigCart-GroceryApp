    ...
    <SafeAreaView style={styles.WelcomePage}>
      ...
      <View style={styles.Section}>
        <View style={{width: 320, gap: 10, marginTop: 15}}>
          <Text style={{fontWeight: 600, fontSize: 24, textAlign: 'center'}}>Welcome</Text>
          <Text style={{color: '#868889', textAlign: 'center', marginBottom: 10, fontSize: 15, fontWeight: 400}}>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy</Text>
        </View>
        <View style={styles.ButtonContainer1}>
          <View style={{borderRadius: 5}}>
            <TouchableOpacity style={styles.Button}>
              <Image source={require('../assets/googleLogo.png')} style={{position: 'relative', right: 70}}/>
        ...
        <LinearGradient 
          ...
          start={{ x: 0, y: 1}}
            ...
            <TouchableOpacity style={styles.Button} onPress={() => navigation.navigate('Sign up screen')}>
              <Image source={require('../assets/signUpVector.png')} style={{position: 'relative', right: 80}}/>
