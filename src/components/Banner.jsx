...
const BannerList = [
    {id: 1, image: require('../assets/foodBanner.png')},
    {id: 2, image: require('../assets/foodBanner.png')},
    {id: 3, image: require('../assets/foodBanner.png')}
]
...
export default function Banner() {
  ...
  return (
    <>
        <ScrollView horizontal pagingEnabled showsHorizontalScrollIndicator={false} onScroll={onScroll}>
            {BannerList.map(item => (
                <Image key={item.id} source={item.image} style={{width: ITEM_SIZE}} resizeMode='cover'/>
            ))}
        </ScrollView>
