    ...
    return (
        <View style={styles.Products}>
            <View style={{backgroundColor: 'white', paddingVertical: 2, alignItems: 'center', justifyContent: 'center'}}>
                <TouchableOpacity>
                    <Image source={require('../assets/heartVector1.png')} style={{marginLeft: 150, marginTop: 1}}/>
                </TouchableOpacity>
            </View>
            <View style={{gap: 1}}>
                <View style={{backgroundColor: 'white'}}>
                    <TouchableOpacity style={styles.ProductsTopContainer}>
                        <View>
                            <View style={{backgroundColor: `${props.product.color}`, width: 84, height: 84, borderRadius: 50}}>
                            ...
                            <View style={styles.ProductsDetailsSection}>
                                ...
                                <Text style={styles.ProductQuantity}>{props.product.quantity}</Text>
                            </View>
                        </View>
                    </TouchableOpacity>
                </View>
